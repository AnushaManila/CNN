...
#**************************************************************
savedFilter = np.ravel(np.array(np.load('kept_filters5-5.npy'), dtype='int32'))
print ('savedFilter:', savedFilter.shape) #(753664,) 32*32*32*23 = 753664
sliced32 = savedFilter[-32768:] # 23 such
sliced90 = savedFilter[0:729000]
 
filterVolume32 = sliced32.reshape([32,32,32]) 
#Display 3D data
pg.image(filterVolume32)

filterVolume90 = sliced90.reshape([90,90,90]) 
#Display 3D data
#pg.image(filterVolume90)
